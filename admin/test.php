...
<div id="view-details-modal" class="fixed inset-0 z-50 overflow-y-auto">
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div id="event-details-content" class="mt-2">
                            <!-- This will be populated when a user clicks "View Details" -->
                            <div class="flex flex-col md:flex-row gap-6">
                                ...
                                <div class="w-full md:w-1/2">
                                    ...
                                    <div class="mt-6">
                                        <button class="w-full bg-[#009332] hover:bg-[#007A2A] text-white py-2 px-4 rounded-md transition focus:outline-none focus:ring-2 focus:ring-[#009332] focus:ring-offset-2">
                                            Get Tickets
                                        </button>
                                    </div>
                                </div>
