<nav class="bg-white w-full p-1 shadow-3xl border-b-1 border-b-gray-200 sticky top-0 z-50">
...
<div class="text-black text-lg font-semibold cursor-pointer p-2 flex items-center">
    ...
    <div id="mobile-menu" class="fixed inset-y-0 left-0 w-64 bg-white shadow-xl transform -translate-x-full transition-transform duration-300 ease-in-out z-50">
        ...
        <div class="flex flex-col space-y-4 px-6 py-1">
            ...
            <a href="/admin/dashboardAdmin.php" class="text-black font-regular p-2 hover:bg-gray-100 rounded flex items-center"><img src="/public/image/dashboard.png" alt="" class="w-5 h-5"> <span class="pl-3">Dashboard</span></a>
            <a href="/admin/user.php" class="text-black font-regular p-2 hover:bg-gray-100 rounded flex items-center"><img src="/public/image/programmer.png" alt="" class="w-6 h-6"> <span class="pl-3">Users</span></a>
            <a href="/admin/event.php" class="text-black font-regular p-2 hover:bg-gray-100 rounded flex items-center"><img src="/public/image/event.png" alt="" class="w-6 h-6"> <span class="pl-3">Event</span></a>
            <a href="/admin/ticket.php" class="text-black font-regular p-2 hover:bg-gray-100 rounded flex items-center"><img src="/public/image/ticket.png" alt="" class="w-6 h-6"> <span class="pl-3">Ticket</span></a>
        </div>
    </div>
